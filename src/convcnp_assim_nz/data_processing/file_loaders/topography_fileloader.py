...
class TopographyFileLoader():
    """
    Class to load the topography file.
    Handles all the interaction with the file system.
    Assumes that:
        - topography file is stored at DATA_HOME/TOPOGRAPHY_SUFFIX/TOPOGRAPHY_FILE
    """

    def __init__(self):
        pass

    def load_topography_file(self) -> xr.Dataset:
